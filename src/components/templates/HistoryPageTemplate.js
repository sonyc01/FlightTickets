...
import { IonContent, IonHeader,IonToolbar,IonTitle, IonPage,IonButtons,IonBackButton,IonButton } from '@ionic/react';
    ...
    return(
        <IonPage>
            ...
            <IonToolbar>
                    ...
                    <IonButtons slot="end">
                        <IonButton onClick={onClearClick}>
                            Clear
                        </IonButton>
                    </IonButtons>
                </IonToolbar>
