  ...
  return (
    <IonPage>
      ...
      <IonContent>
            ...
            <IonRow>
              <IonCol>
                ...
                <IonInput
                  ...
                  onIonChange={(e) =>
                    onDepartureInputTextChange(e.detail.value)
                  }
                />
              </IonCol>
              <IonCol>
            ...
            <IonRow>
              <IonCol>
                ...
                <IonInput
                  ...
                  onIonChange={(e) =>
                    onDestinationInputTextChange(e.detail.value)
                  }
                />
              </IonCol>
              <IonCol>
                <IonButton
                  color="primary"
                  expand="block"
                  onClick={onDestinationSearchClick}
                >
                  <IonIcon slot="start" icon={search} />
                  Destination Search
                </IonButton>
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardSubtitle>Departure Date</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            <IonItem>
              <IonDatetime
                ...
                value={departureDate}
                onIonChange={(e) => onDepartureDateChange(e.detail.value)}
              />
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardSubtitle>Return Date</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            <IonItem>
              <IonDatetime
                displayFormat="YYYY-MM-DD"
                value={returnDate}
                onIonChange={(e) => onReturnDateChange(e.detail.value)}
              />
              <IonIcon icon={calendar} slot="end" />
            </IonItem>
          </IonCardContent>
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardSubtitle>Travelers</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            <IonItem>
              <IonRange
                ...
                snaps={true}
                value={travelerCount}
                onIonChange={(e) => onTravelerCountChange(e.detail.value)}
              />
            </IonItem>
          </IonCardContent>
        </IonCard>
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardSubtitle>Direction</IonCardSubtitle>
          </IonCardHeader>
          <IonCardContent>
            <IonRadioGroup
              value={direction}
              onIonChange={(e) => onDirectionChange(e.detail.value)}
            >
              <IonItem>
